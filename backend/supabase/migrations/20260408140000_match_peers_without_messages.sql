-- Mutual matches to show on the Matches tab: hide for both users as soon as any DM
-- exists between them (conversation_participants). Do not create a DM on match in the app;
-- create it when someone opens chat from Matches (get_or_create_match_conversation).
